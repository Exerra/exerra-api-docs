...
![Guilds](https://img.shields.io/badge/dynamic/json?color=success&label=Guilds&query=servercount&url=https%3A%2F%2Fapi.exerra.xyz%2Fkaren%2Fstats%2F)
![Users](https://img.shields.io/badge/dynamic/json?color=success&label=Users&query=users&url=https%3A%2F%2Fapi.exerra.xyz%2Fkaren%2Fstats%2F)
![DiscordJS version](https://img.shields.io/badge/dynamic/json?color=informational&label=DiscordJS&prefix=v&query=DiscordJS&url=https%3A%2F%2Fapi.exerra.xyz%2Fkaren%2Fstats%2F)
...
Karen bot is a Discord bot with many great features. It features Reddit commands, moderation commands, Spotify commands, and much more. To view a full list of commands, [click here](users/commands)
